...
export class AdbScrcpyOptions2_5<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_5.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions2_5.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions2_5 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_5.Init<TVideo>;
}
