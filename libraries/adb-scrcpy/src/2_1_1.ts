...
export class AdbScrcpyOptions2_1_1<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_1_1.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
...
export namespace AdbScrcpyOptions2_1_1 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_1_1.Init<TVideo>;
}
