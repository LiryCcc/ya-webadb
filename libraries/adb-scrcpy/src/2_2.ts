...
export class AdbScrcpyOptions2_2<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_2.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions2_2.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions2_2 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_2.Init<TVideo>;
}
