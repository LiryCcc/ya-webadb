...
export class AdbScrcpyOptions3_1<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_1.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
...
export namespace AdbScrcpyOptions3_1 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_1.Init<TVideo>;
}
