...
export class AdbScrcpyOptions3_0_2<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_0_2.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions3_0_2.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions3_0_2 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_0_2.Init<TVideo>;
}
