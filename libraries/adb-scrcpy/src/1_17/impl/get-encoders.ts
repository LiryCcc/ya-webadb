...
import type { ScrcpyEncoder, ScrcpyOptions1_17, ScrcpyOptionsListEncoders } from '@yume-chan/scrcpy';
...
export async function getEncoders(
  adb: Adb,
  path: string,
  options: AdbScrcpyOptions<Pick<ScrcpyOptions1_17.Init, 'tunnelForward'>> & ScrcpyOptionsListEncoders
