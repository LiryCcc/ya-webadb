...
export class AdbScrcpyOptions3_2<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_2.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
...
export namespace AdbScrcpyOptions3_2 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_2.Init<TVideo>;
}
