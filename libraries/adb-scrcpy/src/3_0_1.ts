...
export class AdbScrcpyOptions3_0_1<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_0_1.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions3_0_1.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions3_0_1 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_0_1.Init<TVideo>;
}
