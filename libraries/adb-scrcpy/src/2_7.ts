...
export class AdbScrcpyOptions2_7<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_7.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions2_7.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions2_7 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_7.Init<TVideo>;
}
