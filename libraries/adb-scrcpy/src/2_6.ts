...
export class AdbScrcpyOptions2_6<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_6.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions2_6.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions2_6 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_6.Init<TVideo>;
}
