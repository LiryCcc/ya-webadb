...
export class AdbScrcpyOptions2_3<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_3.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
...
export namespace AdbScrcpyOptions2_3 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_3.Init<TVideo>;
}
