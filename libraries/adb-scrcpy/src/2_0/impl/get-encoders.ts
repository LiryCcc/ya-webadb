...
import type { ScrcpyEncoder, ScrcpyOptions2_0, ScrcpyOptionsListEncoders } from '@yume-chan/scrcpy';
...
export async function getEncoders(
  adb: Adb,
  path: string,
  options: AdbScrcpyOptions<Pick<ScrcpyOptions2_0.Init, 'tunnelForward'>> & ScrcpyOptionsListEncoders
