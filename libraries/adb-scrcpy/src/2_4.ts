...
export class AdbScrcpyOptions2_4<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_4.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions2_4.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions2_4 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_4.Init<TVideo>;
}
