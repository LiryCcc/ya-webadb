...
export class AdbScrcpyOptions2_1<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions2_1.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions2_1.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions2_1 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions2_1.Init<TVideo>;
}
