...
export class AdbScrcpyOptions3_3_2<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_3_2.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
...
export namespace AdbScrcpyOptions3_3_2 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_3_2.Init<TVideo>;
}
