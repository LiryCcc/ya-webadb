...
export class AdbScrcpyOptions3_0<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_0.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
  readonly version: string;

  readonly spawner: AdbNoneProtocolSpawner | undefined;

  constructor(init: ScrcpyOptions3_0.Init<TVideo>, clientOptions?: AdbScrcpyClientOptions) {
    super(init);
...
export namespace AdbScrcpyOptions3_0 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_0.Init<TVideo>;
}
