...
export class StickyEventEmitter<TEvent, TResult = unknown> extends EventEmitter<TEvent, TResult> {
  #value: TEvent | typeof Undefined = Undefined;

  protected override addEventListener(info: EventListenerInfo<TEvent, TResult>): RemoveEventListener {
