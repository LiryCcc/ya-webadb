...
import { AdbFeature, AdbShellProtocolProcessImpl, adbShellProtocolSpawner, escapeArg } from '@yume-chan/adb';

import { Cmd } from './service.js';
import { checkCommand, resolveFallback, serializeAbbService } from './utils.js';

export function createShellProtocol(adb: Adb, fallback: NonNullable<Cmd.Fallback>): Cmd.ShellProtocolService;
export function createShellProtocol(adb: Adb, fallback?: Cmd.Fallback): Cmd.ShellProtocolService | undefined;
export function createShellProtocol(adb: Adb, fallback?: Cmd.Fallback): Cmd.ShellProtocolService | undefined {
