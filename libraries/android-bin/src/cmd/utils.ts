...
export function resolveFallback(fallback: Cmd.Fallback, command: string): string {
...
export function serializeAbbService(prefix: string, command: readonly string[]): string {
