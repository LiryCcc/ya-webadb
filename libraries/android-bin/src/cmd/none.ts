...
import { AdbFeature, AdbNoneProtocolProcessImpl, adbNoneProtocolSpawner, escapeArg } from '@yume-chan/adb';

import { Cmd } from './service.js';
import { checkCommand, resolveFallback, serializeAbbService } from './utils.js';

export function createNoneProtocol(adb: Adb, fallback: NonNullable<Cmd.Fallback>): Cmd.NoneProtocolService;
export function createNoneProtocol(adb: Adb, fallback?: Cmd.Fallback): Cmd.NoneProtocolService | undefined;
export function createNoneProtocol(adb: Adb, fallback?: Cmd.Fallback): Cmd.NoneProtocolService | undefined {
