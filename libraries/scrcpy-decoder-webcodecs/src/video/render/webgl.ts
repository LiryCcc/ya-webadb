...
import { glCreateContext, glIsSupported, glLoseContext } from '@yume-chan/scrcpy-decoder-tinyh264';
...
`;
  ...
  constructor(canvas?: HTMLCanvasElement | OffscreenCanvas, enableCapture?: boolean) {
    ...
    gl.texParameteri(
      ...
      gl instanceof WebGL2RenderingContext ? gl.NEAREST_MIPMAP_LINEAR : gl.NEAREST
    );
