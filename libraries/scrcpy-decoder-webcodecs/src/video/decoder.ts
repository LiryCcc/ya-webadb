...
import { PauseControllerImpl, PerformanceCounterImpl } from '@yume-chan/scrcpy-decoder-tinyh264';
  ...
  constructor({ codec, renderer, ...options }: WebCodecsVideoDecoder.Options) {
    ...
    this.#rawDecoder = new VideoDecoder({
      output: (frame) => {
        ...
        this.#decodingTime += performance.now() - frame.timestamp / 1000;
    ...
    switch (this.#codec) {
      case ScrcpyVideoCodecId.H264:
        this.#decoder = new H264Decoder(this.#rawDecoder, this.#updateSize, this.#options);
        break;
      case ScrcpyVideoCodecId.H265:
        this.#decoder = new H265Decoder(this.#rawDecoder, this.#updateSize, this.#options);
        break;
      case ScrcpyVideoCodecId.AV1:
        this.#decoder = new Av1Codec(this.#rawDecoder, this.#updateSize, this.#options);
        break;
      default:
